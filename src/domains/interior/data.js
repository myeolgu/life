...
export const timeline = [
  { day: "2026.09.20", task: "철거: 욕실 철거, 현관/베란다 타일 철거, 기존 문·몰딩 철거, 폐기물 반출" },
  { day: "2026.09.21 ~ 2026.09.22", task: "욕실 방수 (1차·2차) 및 양생" },
  { day: "2026.09.23 ~ 2026.09.24", task: "타일: 욕실 벽/바닥, 베란다, 현관 타일 시공" },
  { day: "2026.09.25", task: "목공: 천장 몰딩, 문틀 보수, 걸레받이 밑작업" },
  { day: "2026.09.26", task: "전기: 콘센트 증설(3~4개) 및 배선 정리" },
  { day: "2026.09.27", task: "문 설치: 방문 3개, 욕실문 1개" },
  { day: "2026.09.28", task: "필름 시공: 싱크대 하부장 필름, 현관문 안쪽 필름" },
  { day: "2026.09.29 ~ 2026.10.01", task: "도배: 벽 + 천장 전체(LX 베스띠 실크벽지), 건조 양생" },
  { day: "2026.10.02 ~ 2026.10.03", task: "장판 시공 (3.0T)" },
  { day: "2026.10.04", task: "걸레받이 최종 마감 설치" },
  { day: "2026.10.05", task: "욕실 마감재 설치: 변기, 세면대, 수전, 환풍기, 조명 / 싱크대 상판 교체" },
  { day: "2026.10.06 ~ 2026.10.07", task: "최종 점검, 하자보수 체크, 입주 청소" },
];
