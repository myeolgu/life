...
export const contractors = [
  ...
  },
  {
    ...
    distance: "부개주공1단지로부터 직선거리 약 1.70km — 디자인큐원과 거의 비슷함",
    contact: "확인 안 됨 (사업자등록번호 137-12-10706으로 추정)",
    note: "소윤님 추천 (2026-09-14, 네이버 지도 링크로 공유받음 — 주소(3층 305호 포함) 사용자가 직접 확인). 실내건축공사업 등록 확인됨 (kiscon.net 조회, 2026-09-14). 참고: 이전 웹검색에서는 '인천 계양구' 소재라는 정보가 나왔었는데, 실제 확인된 주소는 부천 상동이라 차이가 있음 — 전화번호로 한 번 더 확인 권장.",
    verified: false,
  },
];
