...
export const contractors = [
  {
    ...
    distance: "부개주공1단지로부터 직선거리 약 1.76km — 데코크로스디자인과 거의 비슷함",
  ...
  },
  {
    ...
    distance: "부개주공1단지로부터 직선거리 약 0.9km — 3곳 중 가장 가까움",
    contact: "032-519-8787 / 010-9229-8787 (카카오톡: 봄인테리어)",
    note: "소윤님 추천 (2026-09-14, blog.naver.com/bominterior 블로그 캡처로 확인). 실내건축공사업 등록 확인됨 (kiscon.net 조회, 2026-09-14). 전화번호·주소(2층) 모두 사용자가 직접 확인. 좌표는 OpenStreetMap Nominatim 지오코딩으로 확인 — display_name이 'GS수퍼마켓 인천부개점, 10, 부개로...'로 정확히 일치.",
    verified: true,
  },
  {
    no: 3,
    name: "데코크로스디자인",
    address: "경기도 부천시 원미구 상동로117번길 31 (상동, 대림타운)",
    distance: "부개주공1단지로부터 직선거리 약 1.70km — 디자인큐원과 거의 비슷함 (제일 멀다고 봤던 건 오류였음, 재계산으로 정정)",
    contact: "확인 안 됨 (사업자등록번호 137-12-10706으로 추정)",
    note: "소윤님 추천 (2026-09-14, 네이버 지도 링크로 공유받음 — 주소는 사용자가 직접 확인). 실내건축공사업 등록 확인됨 (kiscon.net 조회, 2026-09-14). 참고: 이전 웹검색에서는 '인천 계양구' 소재라는 정보가 나왔었는데, 실제 확인된 주소는 부천 상동이라 차이가 있음 — 전화번호로 한 번 더 확인 권장.",
    verified: false,
  },
];
