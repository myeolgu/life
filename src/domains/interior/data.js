...
export const contractors = [
  ...
  },
  {
    no: 3,
    name: "데코크로스디자인",
    address: "인천광역시 계양구 (정확한 도로명 주소 확인 안 됨)",
    distance: "확인 안 됨",
    contact: "확인 안 됨 (사업자등록번호 137-12-10706으로 추정)",
    note: "소윤님 추천 (2026-09-14, 네이버 지도 링크로 공유받음). 홈페이지(decocross.com) 접속이 안 돼서 상세 정보 확인 못함. 실내건축공사업 등록 확인됨 (kiscon.net 조회, 2026-09-14) — 다만 정확한 도로명 주소·연락처는 아직 확인 안 됨, 상담 잡기 전 확인 필요.",
    verified: false,
  },
];
