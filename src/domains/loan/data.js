...
export const finance = {
  events: [
    ...
    { date: "2026-10-04 (경)", desc: "대출 신청 서류 일괄 발급 (등본·초본·가족관계증명서·등기부등본·전입세대확인서 등, 발급 후 1개월 유효 — 10/11 신청 기준 딱 1주 전)" },
    { date: "2026-10-11 (목표)", desc: "기금e든든 구입자금대출 신청(자산심사 포함), 취급지점: 신림역금융센터. 잔금일(12/10) 기준 2개월 전 — 은행 담당자 안내 + 기금e든든 온라인 신청 최소 리드타임(55~70일) 규정과 부합" },
    { date: "2026-10-12 ~ 10-21 (예상)", desc: "적격판정 통보 (사전자산심사 결과, 통상 며칠~10일 소요). 통보받는 즉시 그날 WON Time으로 다음 영업일 방문 예약" },
    { date: "판정 통보 익일 (예상 10월 중순)", desc: "신림역금융센터 방문 — 서류 제출 및 본심사(정식 대출심사) 개시. 여기서부터가 최종 승인 심사 단계 — 적격판정은 예비 심사일 뿐 최종 승인이 아님" },
...
export const events = [
  ...
  },
  {
    ...
    start: "2026-10-04",
    description: "등본·초본·가족관계증명서·등기부등본·전입세대확인서 등 (발급 후 1개월 유효 — 10/11 신청 기준 1주 전 발급).",
  },
  {
    ...
    start: "2026-10-11",
    description:
      "기금e든든에서 구입자금대출 신청(자산심사 포함), 취급지점: 신림역금융센터. 잔금일(12/10) 기준 2개월 전 — 우리은행 담당자 안내(2026-09-14, 구두) + 기금e든든 온라인 신청 최소 리드타임(대출희망일=신청일 기준 55~70일 이후 지정 가능) 규정과 부합. 너무 일찍 신청하면(예: 9/15) 심사가 통상 속도로 끝날 경우 승인이 일찍 나서 '승인 후 30일 실행' 기한이 잔금일보다 먼저 만료될 위험이 있어 이 날짜로 조정함 (2026-09-14 재검토).",
  },
  {
  ...
  },
  {
    ...
    start: "2026-11-03",
    description:
      "서류 제출 및 본심사(정식 대출심사) 개시. 정확한 날짜는 적격판정 통보 시점에 달려있어 유동적이다 (여기 날짜는 신청일 기준 3주 뒤로 잡은 잠정 예상일). 한국주택금융공사 「내집마련 디딤돌 대출 업무처리기준」(2023-10-06 개정) 공식 확인: 접수일(10/11)로부터 대출승인까지 40일 이내(공사 사전심사 기준), 승인일로부터 30일 이내 실행. 12/10 실행이 유효하려면 승인이 11/11~11/20 사이에 나야 안전 — 9/18 신림역금융센터 상담 때 이 승인 타이밍 조절 가능 여부를 반드시 확인할 것.",
  },
  {
...
export const progress = [
  ...
  { id: "loan:docs-issued", done: false, label: "대출 신청 서류 일괄 발급 (목표 2026-10-04)" },
  { id: "loan:fund-apply", done: false, label: "기금e든든 구입자금대출 신청 (목표 2026-10-11, 신림역금융센터)" },
