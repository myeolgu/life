...
export const events = [
  ...
  },
  {
    ...
    start: "2026-11-03",
    description:
      "서류 제출 및 본심사(정식 대출심사) 개시. 정확한 날짜는 적격판정 통보 시점에 달려있어 유동적이다 (여기 날짜는 신청일 기준 3주 뒤로 잡은 잠정 예상일). '승인 후 30일 이내 실행' 규정의 기산점은 이 본심사가 끝나고 나오는 최종 승인일이지, 이 방문일이나 적격판정일이 아니다.",
  },
  {
