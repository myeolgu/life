...
function Finance() {
  ...
  return (
    <section>
      ...
      <h3>서류별 발급처 & 유효기간</h3>
      <p className="muted">
        9/18 신림역금융센터 상담 시 받은 안내문 기준 — "계약서 제외" 모든 서류는 발급 후 1개월 이내만 유효합니다. 매매계약서는 이 예외에 명시적으로 포함되고, 부동산 거래계약 신고필증은 안내문 하단에 손글씨로 추가된 항목이라 이 예외 적용 여부가 명확치 않습니다 — 헷갈리면 발급 1개월 이내로 맞춰서 안전하게 가는 게 좋습니다.
      </p>
      <table className="data-table">
        <thead>
